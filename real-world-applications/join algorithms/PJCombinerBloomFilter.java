...
public class PJCombinerBloomFilter {
...
private BloomFilter filter = new BloomFilter(100*10000, 12, Hash.MURMUR_HASH);
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {
		...
		if (args.length == 0) { 
			...
			args = new String[] { 
					...
					"hdfs://192.168.159.132:9000/data/cdh/research/join-test/output-pjoin-com-bloom", 
					"@jointype=inner",
	...
	//	counterJon.setReducerClass(DocReducer.class);
		...
		job.setJarByClass(PJCombinerBloomFilter.class);
