package cn.edu.bjtu.cdh.catla.ml.test.javaml;
...
public class TutorialEvaluateDataset {
    ...
    public static void main(String[] args) throws Exception { /* Load a data set */
        Dataset data = FileHandler.loadDataset(new File("E:\\CatlaHS\\machine_learning\\javaml-datasets\\UCI-small\\UCI-small\\iris/iris.data"), 4, ",");
        /*
         ...
         */
        Dataset dataForClassification = FileHandler.loadDataset(new File("E:\\CatlaHS\\machine_learning\\javaml-datasets\\UCI-small\\UCI-small\\iris/iris.data"), 4, ",");
