...
public class LinePredictor extends CommonPredictor implements Predictor {
	// raw data
	...
	public LinePredictor(Map<String, String> options, String[] xfields, String[] yfields, String[][] xdata,
			String[][] ydata) {
	...
	public void fit() {
		...
		this.model_result = MathUtil.lineFitting(this.x[0], this.y);
	...
	public void predict() {
		...
		for (int i = 0; i < x_data[0].length; i++) {
			double predicted_y = this.model_result[0] + this.model_result[1] * this.x[0][i];
