...
public class XYsChart implements CatlaChart {
	...
	public XYsChart(String title,String xTitle,String yTitle,String[][] X,String[][] Y,String[] seriesNames) {
		this.title=title;
		this.x_title=xTitle;
		this.y_title=yTitle;
		this.x_data=X;
	...
	public Chart getChart() {
		...
		// System.out.println(x_series.size());
			...
			for(int j=0;j<y_series.size();j++) {
				XYSeries series = chart.addSeries(seriesNames[j],x_series.get(0),y_series.get(j));
